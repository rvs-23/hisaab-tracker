...
# Nav reads as the money pipeline: in -> split (allocation is edited on Budget,
# under the monthly split) -> record actuals; Rent vs buy is a calculator, not a stop.
st.navigation(
    [
        ...
        st.Page("views/rent_vs_buy.py", title="Rent vs buy", icon=":material/home:"),
    ]
).run()
